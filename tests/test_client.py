import pytest
from apis.client import Loan
from datetime import datetime


def test_should_get_client_books_without_fees(client, mocker):

    with mocker.patch.object(Loan, '_get_today', return_value=datetime(2021, 3, 21)):
...
def test_should_get_client_books_with_3_days_fee(client, mocker):
    ...
    with mocker.patch.object(Loan, '_get_today', return_value=datetime(2021, 3, 25)):
        response = client.get("/clients/1/books")
...
def test_should_get_client_books_with_3_days_fee_2(client, mocker):
    ...
    with mocker.patch.object(Loan, '_get_today', return_value=datetime(2021, 3, 24)):
        response = client.get("/clients/1/books")
...
def test_should_get_client_books_with_5_days_fee(client, mocker):
    ...
    with mocker.patch.object(Loan, '_get_today', return_value=datetime(2021, 3, 27)):
        response = client.get("/clients/1/books")
...
def test_should_get_client_books_with_5_days_fee_2(client, mocker):
    ...
    with mocker.patch.object(Loan, '_get_today', return_value=datetime(2021, 3, 28)):
        response = client.get("/clients/1/books")
...
def test_should_get_client_books_with_more_than_5_days_fee(client, mocker):
    ...
    with mocker.patch.object(Loan, '_get_today', return_value=datetime(2021, 3, 31)):
        response = client.get("/clients/1/books")
...
def test_should_get_client_books_with_more_than_5_days_fee_2(client, mocker):
    ...
    with mocker.patch.object(Loan, '_get_today', return_value=datetime(2021, 3, 30)):
        response = client.get("/clients/1/books")
...
def test_should_not_get_books_client_not_found(client, mocker):

    with mocker.patch.object(Loan, '_get_today', return_value=datetime(2021, 3, 30)):
        response = client.get("/clients/4/books")
